...
function (_Component) {
  ...
  function EventColorList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      selectedColor: colors[0] // componentDidMount () {
      //     console.log(isEmpty(this.props.selectedColor))
      //     if (!isEmpty(this.props.selectedColor)) {
      //         this.setState({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "selectThisColor", function (selectedColor) {
      ...
      _this.setState({
        ...
        _this.props.setEventColor(selectedColor);
      });
    });
...
//# sourceMappingURL=edit.js.38c4f7bb1bd3375ce1ec.hot-update.js.map